...
def plot_3D_twocolor(Conc_grain1, Conc_grain2, x_values_grain1, x_values_grain2, duration, Nt):
    ...
    plt.savefig('Element_Partitioning_and_Diffusion/Plots/ElemPart_two_grains_var_diff_mBC_3D_twocolor.png', dpi=300)
...
def plot_3D(Conc_grain1, Conc_grain2, x_values_grain1, x_values_grain2, duration, Nt):
    ...
    plt.savefig('Element_Partitioning_and_Diffusion/Plots/ElemPart_two_grains_var_diff_mBC_3D.png', dpi=300)
...
def plot_2D(Conc_grain1, Conc_grain2, x_values_grain1, x_values_grain2, duration, Nt):
    ...
    plt.legend()
    plt.savefig('Element_Partitioning_and_Diffusion/Plots/ElemPart_two_grains_var_diff_mBC.png', dpi=300)

...
def my_code():
    ...
    C_grain1[0, :] = -0.02 * (x_values_grain1 - L_grain1/2)**2 + 200
    C_grain2[0, :] = -0.02 * (x_values_grain2 - int(L_grain2/2+L_grain1))**2 + 150
    ...
    for n in range(0, Nt - 1):
        ...
        C_grain1[n + 1, -1] = (alpha_grain1[-1]*C_grain1[n+1, -2] + alpha_grain2[0]*C_grain2[n+1, 1]) / (alpha_grain1[-1] + gamma*alpha_grain2[0])
        C_grain2[n + 1, 0] = (alpha_grain1[-1]*C_grain1[n+1, -2] + alpha_grain2[0]*C_grain2[n+1, 1]) / (alpha_grain1[-1]/gamma + alpha_grain2[0])
        T_rod1[n + 1, -1] = (alpha_rod1[-1]*T_rod1[n+1, -2] + alpha_rod2[0]*T_rod2[n+1, 1]) / (alpha_rod1[-1] + gamma*alpha_rod2[0])
        T_rod2[n + 1, 0] = (alpha_rod1[-1]*T_rod1[n+1, -2] + alpha_rod2[0]*T_rod2[n+1, 1]) / (alpha_rod1[-1]/gamma + alpha_rod2[0])
...
def plot_3D():
    ...
    ax.plot_surface(X_total, t_values_total, C_total, cmap='viridis')

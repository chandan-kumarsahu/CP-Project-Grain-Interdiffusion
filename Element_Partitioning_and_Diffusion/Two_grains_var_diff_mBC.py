...
def plot_3D():
    ...
    plt.savefig('Heat_diffusion_in_metal_rods/Plots/HeatDiff_two_connected_rods_mdiff_mBC_3D.png', dpi=300)
...
def plot_2D():
    ...
    plt.legend()
    plt.savefig('Heat_diffusion_in_metal_rods/Plots/HeatDiff_two_connected_rods_mdiff_mBC.png', dpi=300)
